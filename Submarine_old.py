...
class Submarine:
    ...
    def update_position(self):
        ...
        if (len(self.detections) > 0) & (self.return_fun == False):
            ...
            self.tracking_timer[self.tracking_timer_index] += 1
            ...
            if self.loc.dist_to(self.detections[0].loc) > 20000/2000:
            ...
            elif (self.loc.dist_to(self.detections[0].loc) <= 20000/2000):
                ...
                if (self.ranging_timer <= 0) and len(self.detections) > 0 :
        ...
        elif (len(self.detections) == 0) & (self.return_fun == False):
        ...
        if (self.loc.lon >= 110 + (self.indexer - 1)*200) & (len(self.detections) == 0):
            self.return_fun = True
            self.crs = 270
        if (self.return_fun == True) & ((95 + (self.indexer - 1)*200) < self.loc.lon < (105 + (self.indexer - 1)*200)):
            self.return_fun = False
