...
if __name__ == "__main__":
    ...
    n_merchants = 1
    n_submarines = 1
    Targets, Merchants, Submarines = Simulator(n_targets,n_merchants,n_submarines,12,5e5,False,False)
    
    print(Submarines[0].tracked,Submarines[0].tracking_timer/5e5)
